...
interface ProductState {
  ...
  newArrivals: Product[];          // New arrivals list
...
export const loadProductBySlug = createAsyncThunk<Product, string>(
  'product/loadProductBySlug',
  async (slug: string) => {
...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Handle loadProductBySlug lifecycle actions
